...
// (C) Copyright 2005-2010 Hartmut Kaiser
// (C) Copyright 2009 Edward Grace
//
...
#if !defined(ARIEL_HIGH_RESOLUTION_TIMER_HXX)
#define ARIEL_HIGH_RESOLUTION_TIMER 
...
namespace ariel {
  class high_resolution_timer {
   public:
    high_resolution_timer (void) { restart();} 
...
#endif // ARIEL_HIGH_RESOLUTION_TIMER_HXX 
